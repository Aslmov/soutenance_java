...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 10 jan. 2025 à 01:59
...
--
-- Base de données : `pizzaboxinnodb`
--
...
CREATE TABLE IF NOT EXISTS `pizza` (
  ...
  `image1_chemin` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  PRIMARY KEY (`NROPIZZ`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=458 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;

--
-- Déchargement des données de la table `pizza`
--

INSERT INTO `pizza` (`NROPIZZ`, `DESIGNPIZZ`, `TARIFPIZZ`, `image1_chemin`) VALUES
(1, 'pizza caviar', 250.00, 'd:/image_12.jpg'),
(2, 'La Seguin', 13.50, NULL),
(3, 'La From', 14.50, NULL),
(4, 'La Fermière', 12.50, NULL),
(5, 'La chausson', 13.00, NULL),
(6, 'La Provençale', 12.50, NULL),
(7, 'La Caramba', 14.50, NULL),
(8, 'l\'Orient Express', 14.50, NULL),
(9, 'La Gourmande', 14.50, NULL),
(10, 'La primeure', 12.50, NULL),
(11, 'La Péloponèse', 14.50, NULL),
(12, 'La Savoyarde', 14.50, NULL),
(13, 'la Pêcheur', 13.50, NULL),
(456, 'puree', 19.20, NULL),
(457, '8 fromages', 12.00, NULL);
